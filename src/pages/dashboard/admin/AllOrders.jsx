...
const AllOrders = () => {
  ...
  useEffect(() => {
    ...
    const url = status
      ? `https://garmentstracker.vercel.app/api/v1/orders?status=${status}`
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <h2 className="text-2xl font-bold">All Orders (Admin)</h2>
          ...
          <tbody>
            {orders.map((order, index) => (
              <tr key={order._id}>
                ...
                <td className="text-xs text-gray-500">{order._id}</td>
